 ...
 * User CRUD controller — uses Project 2 (Database) model and validators.
 */
const User = require('../../project2-database/models/User');
const { validateUserInput } = require('../../project2-database/utils/validators');

/**
 * Create a new user (admin only — secured in Project 3 routes).
 * POST /api/users
 */
