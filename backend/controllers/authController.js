...
const { validateUserInput, validateEmail } = require('../utils/validators');
...
/**
 * Set HTTP-only cookie and send token response.
...
const updatePassword = async (req, res, next) => {
  try {
    ...
    const validation = validateUserInput({ name: 'placeholder', email: 'a@b.com', password: newPassword });
    if (!validation.valid) {
